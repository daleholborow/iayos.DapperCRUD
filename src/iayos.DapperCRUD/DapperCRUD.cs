...
namespace iayos.DapperCRUD
{
	...
	/// <summary>
	/// Main class for iayos.DapperCRUD extensions, all taken directly from SimpleCRUD (and all credit and thanks given!), just 
	/// renamed so as not to collide, and made some methods public if/as/where required
	/// </summary>
	public static partial class DapperCRUD
	{


		#region iayos.DapperCRUD methods tacked onto Dapper.SimpleCRUD functionality
		...
		#region Dapper.SimpleCRUD functionality
